...
public class CommentController {
    ...
    // 评论点赞/取消
    @PutMapping("/like/{id}")
    public Result<LikeStateVO> likeComment(@PathVariable Long id) {
        return Result.success(commentService.setCommentLikeState(id, true));
    }

    @DeleteMapping("/like/{id}")
    public Result<LikeStateVO> unlikeComment(@PathVariable Long id) {
        return Result.success(commentService.setCommentLikeState(id, false));
    }
}
