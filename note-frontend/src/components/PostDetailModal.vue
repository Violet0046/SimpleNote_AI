                  ...
                  <div class="flex-1">
                    ...
                    <div class="flex items-center justify-between mt-1.5">
                      ...
                      <div class="flex items-center gap-1 cursor-pointer transition-colors" 
                        ...
                        <span class="text-[12px] font-medium" v-if="comment.likesCount">{{ formatCount(comment.likesCount) }}</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="flex-1">
                      ...
                      <div class="flex items-center justify-between mt-1.5">
                        ...
                        <div class="flex items-center gap-1 cursor-pointer transition-colors" 
                          ...
                          <span class="text-[11px] font-medium" v-if="sub.likesCount">{{ formatCount(sub.likesCount) }}</span>
                        </div>
                      </div>
                    </div>
                  </div>
