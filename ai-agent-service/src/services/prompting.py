...
from src.models.content import GeneratePostDraftRequest
...
必须遵守以下规则：
1. 只根据用户提供的素材和关键词写作，不能臆造素材中不存在的具体细节。
...
def build_prompt_package(payload: GeneratePostDraftRequest) -> PromptPackage:
