...
高性能响应式瀑布流发现页，基于 IntersectionObserver 实现无缝触底加载。

仿大厂风格的“上下层级”路由体验：刷流时新开标签页看主页、弹窗式沉浸式帖子详情。

🎨 专业创作者中心

支持一次性上传最多 18 张图片或 1 个高清视频，极简发布流程。
...
结合用户上传图片与短关键词，智能生成种草文案、表情包与热门 Tags。
...
创建名为 simplenote 的 MySQL 数据库。

运行项目根目录下的 init.sql 脚本完成建表。
